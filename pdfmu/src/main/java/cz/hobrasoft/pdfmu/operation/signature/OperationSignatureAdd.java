...
import static cz.hobrasoft.pdfmu.error.PdfmuError.SIGNATURE_ADD_FAIL;
import static cz.hobrasoft.pdfmu.error.PdfmuError.SIGNATURE_ADD_UNSUPPORTED_DIGEST_ALGORITHM;
